...
DATA  SEGMENT
	...
	ERR02 db 'file not found', 13,10, '$' 
	ERR03 db   'route not found', '$' 
	ERR07 db 'memory control block destroyed', 13,10, '$' 
	ERR08 db   'not enough memory', 13,10, '$' 
	ERR09 db 'invalid memory block address', 13,10, '$' 
