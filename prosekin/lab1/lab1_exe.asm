...
ps30:
	mov dx, offset typePC30
	jmp print_type

ps80:
	mov dx, offset typePC80
	jmp print_type
...
ver_defenition proc near
   ...
   add si, 3
	...
	mov si, offset oemNum
	add si, 19
	mov al, bh
	call BYTE_TO_DEC
	mov dx, offset oemNum
	call print
	
	mov di, offset userNum
	add di, 25
	mov ax, cx
	call WRD_TO_HEX
	mov al, bl
