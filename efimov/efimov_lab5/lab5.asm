...
;-------------------------------
CUSTOM_INTERRUPT PROC far
   jmp m_start_custom_interrupt
...
IS_LOAD PROC near
   ...
   sub si,offset CUSTOM_INTERRUPT
   mov dx,es:[bx+si]
   cmp dx, 8f17h
   jne m_is_load_end
   mov flag_load,1h
...
DATA      SEGMENT
   ...
   STR_ALR_LOAD  DB 'Interrupt was already loaded', 0AH, 0DH,'$'
   STR_SUC_LOAD  DB 'Interrupt is loaded', 0AH, 0DH,'$'
